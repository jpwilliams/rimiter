function limit (id, opts) {
  ...
  this.limits[id].currentAllowance = this.limits[id].hasOwnProperty('currentAllowance') ? this.limits[id].currentAllowance : this.limits[id].rate
  ...
  if (this.limits[id].currentAllowance >= 1) {
    ...
    // return that they're not limited
    return false
  }
